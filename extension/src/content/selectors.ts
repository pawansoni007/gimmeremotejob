...
// `id`, `name`, `href`, or semantic tag, which are far more stable. Keeping all
// selectors here means a Wellfound layout change is a one-file fix.
...
// Pull the numeric Wellfound job id out of a /jobs/<id>-<slug> href.
